            ...
            L  f, fun_matches = MG {mg_ext = , mg_alts = 
                L  [L  (Match {m_ext = , m_ctxt = FunRhs {mc_fun = 
                    L  f, mc_fixity = Prefix, mc_strictness = NoSrcStrict}, m_pats = [
                        L  ds_a1zKN], m_grhss = GRHSs {grhssExt = , grhssGRHSs = [
                            L (RealSrcSpan SrcSpanOneLine "other/good/Mod2.hs" 4 6 20 (Just (BufSpan {bufSpanStart = BufPos {bufPos = 44}, bufSpanEnd = BufPos {bufPos = 58}}))) (GRHS  [
